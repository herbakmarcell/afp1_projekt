 ...
 */
export declare function PostFetch(API: str, Data: unknown, Headers?: {
    'Content-Type': string;
}): Promise<unknown>;
/**
 ...
 * @returns a Promise that resolves to an unknown value.
 */
export declare function GetFetch(API: str, Headers?: {
    'Content-Type': string;
}): Promise<unknown>;
/**
 ...
 * @returns a Promise that resolves to an unknown value.
 */
export declare function PutFetch(API: str, Data: unknown, Headers?: {
    'Content-Type': string;
}): Promise<unknown>;
/**
 ...
 * @returns a Promise that resolves to an unknown value.
 */
export declare function DeleteFetch(API: str, Headers?: {
    'Content-Type': string;
}): Promise<unknown>;
export {};
