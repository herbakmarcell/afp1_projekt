...
|    Bejelentkezés    |     2024.11.24      |              Adatok ellenőrzése              |                                                   Minden adatot meg kell adni, azonban ha nincs email cím megadva, akkor leáll a szerver.                                                   |   Hibát találtam.   |
...
|       Jogkör        |     2024.11.24      |              Jogkör módosítása               |        A rendszergazda sikeresen tudja módosítani a felhasználók jogosultságait, kivéve egy másik rendszergazdáét, módosítások után, azonban a szerver a funkió hívása után leállt.         |   Hibát találtam.   |
